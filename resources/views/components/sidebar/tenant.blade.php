...
<div class="space-y-0.5">
    <a href="{{ route('tenant.dashboard') }}" class="group flex items-center gap-x-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all duration-150 {{ str_contains($current, 'dashboard') ? 'sidebar-active shadow-lg' : 'text-gray-400 hover:bg-white/8 hover:text-white' }}">
...
<div class="mt-6">
    ...
    <div class="space-y-0.5">
        ...
        {{-- My Property --}}
        <a href="{{ route('tenant.property.show') }}" class="group flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 {{ str_contains($current, 'property') ? 'bg-white/10 text-white' : 'text-gray-400 hover:bg-white/8 hover:text-white' }}">
            <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4"/></svg>
            My Property
        </a>
