...
{{-- Property Management --}}
<div class="mt-6">
    <p class="mb-2 px-3 text-[10px] font-bold uppercase tracking-[0.15em] text-gray-600">Property Management</p>
    <div class="space-y-0.5">

        {{-- Properties --}}
        <div x-data="{ open: {{ str_contains($current, 'properties') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="w-full flex items-center justify-between rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 {{ str_contains($current, 'properties') ? 'bg-white/10 text-white' : 'text-gray-400 hover:bg-white/8 hover:text-white' }}">
            ...
            <div x-show="open" x-cloak class="mt-1 ml-4 space-y-0.5 border-l border-white/10 pl-4">
                <a href="{{ route('landlord.properties.index') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.properties.index' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">All Properties</a>
                <a href="{{ route('landlord.properties.create') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.properties.create' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">Add Property</a>
            </div>
        </div>

        {{-- Tenants --}}
        <div x-data="{ open: {{ str_contains($current, 'tenants') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="w-full flex items-center justify-between rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 {{ str_contains($current, 'tenants') ? 'bg-white/10 text-white' : 'text-gray-400 hover:bg-white/8 hover:text-white' }}">
                <span class="flex items-center gap-x-3">
            ...
            <div x-show="open" x-cloak class="mt-1 ml-4 space-y-0.5 border-l border-white/10 pl-4">
                <a href="{{ route('landlord.tenants.index') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.tenants.index' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">All Tenants</a>
                <a href="{{ route('landlord.tenants.create') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.tenants.create' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">Add Tenant</a>
            </div>
        </div>

        {{-- Leases --}}
        <div x-data="{ open: {{ str_contains($current, 'leases') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="w-full flex items-center justify-between rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 {{ str_contains($current, 'leases') ? 'bg-white/10 text-white' : 'text-gray-400 hover:bg-white/8 hover:text-white' }}">
                <span class="flex items-center gap-x-3">
            ...
            <div x-show="open" x-cloak class="mt-1 ml-4 space-y-0.5 border-l border-white/10 pl-4">
                <a href="{{ route('landlord.leases.index') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.leases.index' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">All Leases</a>
                <a href="{{ route('landlord.leases.create') }}" class="block rounded-md px-3 py-1.5 text-sm transition {{ $current === 'landlord.leases.create' ? 'text-indigo-400 font-medium' : 'text-gray-500 hover:text-white' }}">Create Lease</a>
            </div>
        </div>
...
{{-- Finance --}}
<div class="mt-6">
    <p class="mb-2 px-3 text-[10px] font-bold uppercase tracking-[0.15em] text-gray-600">Finance</p>
    <div class="space-y-0.5">
...
{{-- Operations --}}
<div class="mt-6">
    <p class="mb-2 px-3 text-[10px] font-bold uppercase tracking-[0.15em] text-gray-600">Operations</p>
    <div class="space-y-0.5">
