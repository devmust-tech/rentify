...
@section('content')
    ...
    <p style="margin: 0 0 24px 0; color: #374151; font-size: 15px; line-height: 1.6;">
        <strong>{{ $orgName }}</strong> has added you as a tenant on Rentify. Click the button below to set up your password and access your tenant portal — view your lease, pay rent, and submit maintenance requests.
    </p>
