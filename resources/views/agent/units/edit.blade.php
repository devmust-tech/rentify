<x-app-layout>
    ...
    <div class="max-w-3xl">
        <form action="{{ route('agent.properties.units.update', [$property, $unit]) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="floor_number" id="floor_number" value="{{ old('floor_number', $unit->floor_number) }}" min="0" max="200"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="size" id="size" value="{{ old('size', $unit->size) }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
                        ...
                        <div>
                            ...
                            <input type="number" name="size_sqm" id="size_sqm" value="{{ old('size_sqm', $unit->size_sqm) }}" step="0.01" min="0"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                        ...
                        <div>
                            ...
                            <select name="furnishing" id="furnishing"
                                ...
                                @foreach(['unfurnished' => 'Unfurnished', 'semi_furnished' => 'Semi-Furnished', 'furnished' => 'Fully Furnished'] as $v => $l)
                                    <option value="{{ $v }}" {{ old('furnishing', $unit->furnishing) === $v ? 'selected' : '' }}>{{ $l }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms', $unit->bedrooms) }}" min="0" max="20"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                        ...
                        <div>
                            ...
                            <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms', $unit->bathrooms) }}" min="0" max="20"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                        ...
                        <div class="flex items-end pb-1">
                            <label class="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-2.5 cursor-pointer transition hover:border-gray-300 has-[:checked]:border-indigo-300 has-[:checked]:bg-indigo-50/50">
                                ...
                                <input type="checkbox" name="balcony" value="1" {{ old('balcony', $unit->balcony) ? 'checked' : '' }}
                ...
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="rent_amount" id="rent_amount" value="{{ old('rent_amount', $unit->rent_amount) }}" step="0.01" min="0"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="deposit_amount" id="deposit_amount" value="{{ old('deposit_amount', $unit->deposit_amount) }}" step="0.01" min="0"
                                       class="block w-full rounded-lg border-gray-300 pl-12 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="service_charge" id="service_charge" value="{{ old('service_charge', $unit->service_charge) }}" step="0.01" min="0"
                                       class="block w-full rounded-lg border-gray-300 pl-12 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="deposit_months" id="deposit_months" value="{{ old('deposit_months', $unit->deposit_months) }}" min="1" max="12"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                        ...
                        <div>
                            ...
                            <select name="billing_cycle" id="billing_cycle"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                                <option value="monthly" {{ old('billing_cycle', $unit->billing_cycle) === 'monthly' ? 'selected' : '' }}>Monthly</option>
                                <option value="quarterly" {{ old('billing_cycle', $unit->billing_cycle) === 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="min_lease_months" id="min_lease_months" value="{{ old('min_lease_months', $unit->min_lease_months) }}" min="1" max="60"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                    ...
                    <div>
                        ...
                        <input type="date" name="available_from" id="available_from" value="{{ old('available_from', $unit->available_from?->format('Y-m-d')) }}"
            ...
            <fieldset class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5">
                ...
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select name="meter_type" id="meter_type"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                                <option value="">Not specified</option>
                                <option value="shared" {{ old('meter_type', $unit->meter_type) === 'shared' ? 'selected' : '' }}>Shared</option>
                                <option value="individual" {{ old('meter_type', $unit->meter_type) === 'individual' ? 'selected' : '' }}>Individual</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="electricity_meter" id="electricity_meter" value="{{ old('electricity_meter', $unit->electricity_meter) }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                        ...
                        <div>
                            ...
                            <input type="text" name="water_meter" id="water_meter" value="{{ old('water_meter', $unit->water_meter) }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
                    ...
                    <div>
                        ...
                        <input type="url" name="video_tour_url" id="video_tour_url" value="{{ old('video_tour_url', $unit->video_tour_url) }}"
                               class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
