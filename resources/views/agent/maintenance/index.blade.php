                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right text-sm">
                            <div class="inline-flex items-center gap-x-3">
                                ...
                                <a href="{{ route('agent.maintenance.edit', $request) }}" class="font-medium text-emerald-600 hover:text-emerald-500 transition-colors">Update</a>
                            </div>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="mt-1 text-sm text-gray-400">Maintenance requests will appear here when submitted.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
