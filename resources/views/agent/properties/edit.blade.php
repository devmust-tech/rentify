        ...
        <form action="{{ route('agent.properties.update', $property) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <fieldset class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5">
                <div class="border-b border-gray-100 bg-gray-50/50 px-6 py-4">
                    ...
                    <p class="mt-0.5 text-sm text-gray-500">Upload new images to replace existing ones</p>
                </div>
                <div class="px-6 py-6">
                    <div>
                        ...
                        <div class="mt-1 flex justify-center rounded-xl border-2 border-dashed border-gray-300 px-6 py-10 transition hover:border-indigo-400">
                            <div class="text-center">
                                ...
                                <p class="mt-1.5 text-xs text-gray-500">PNG, JPG, WEBP up to 5MB each. Replaces existing photos.</p>
                            </div>
                        </div>
