<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Register a new tenant in the system</p>
            </div>
    ...
    <div class="max-w-3xl">
        <form action="{{ route('agent.tenants.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
                                   required placeholder="tenant@example.com">
                    ...
                    <div>
                        ...
                        <select name="preferred_contact" id="preferred_contact"
                            ...
                            @foreach(['phone' => 'Phone Call', 'whatsapp' => 'WhatsApp', 'email' => 'Email', 'sms' => 'SMS'] as $v => $l)
                                <option value="{{ $v }}" {{ old('preferred_contact', 'phone') === $v ? 'selected' : '' }}>{{ $l }}</option>
                            @endforeach
                        </select>
                ...
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="kra_pin" id="kra_pin" value="{{ old('kra_pin') }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
                ...
                <div class="px-6 py-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="guarantor_relationship" id="guarantor_relationship"
                                ...
                                @foreach(['Parent', 'Spouse', 'Sibling', 'Employer', 'Friend', 'Other'] as $rel)
                                    <option value="{{ $rel }}" {{ old('guarantor_relationship') == $rel ? 'selected' : '' }}>{{ $rel }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="guarantor_id" id="guarantor_id" value="{{ old('guarantor_id') }}"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition">
            ...
            {{-- Household --}}
            <fieldset class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5" x-data="{ hasPets: {{ old('has_pets') ? 'true' : 'false' }} }">
                <div class="border-b border-gray-100 bg-gray-50/50 px-6 py-4">
                ...
                <div class="px-6 py-6 space-y-4">
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="occupants" id="occupants" value="{{ old('occupants') }}" min="1" max="20"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
                                   placeholder="1">
                        ...
                        <div>
                            ...
                            <input type="number" name="children" id="children" value="{{ old('children') }}" min="0" max="20"
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
                                   placeholder="0">
                    ...
                    <div x-show="hasPets" x-collapse>
                        ...
                        <input type="text" name="pet_details" id="pet_details" value="{{ old('pet_details') }}"
                               class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition"
