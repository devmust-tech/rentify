            ...
            <div>
                <div class="flex items-center gap-x-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-gray-500">Sent {{ $notification->sent_at?->diffForHumans() }}</p>
                    </div>
                </div>
            </div>
            <a href="{{ route('agent.notifications.index') }}"
            ...
            <div class="border-b border-gray-100 bg-gray-50/50 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-x-3">
                        ...
                        @else
                            <span class="inline-flex items-center gap-x-1 rounded-lg bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-700 ring-1 ring-inset ring-emerald-600/10">
                ...
                <div class="mt-6 border-t border-gray-100 pt-5">
                    <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div class="rounded-lg bg-gray-50/50 p-4">
                            <dt class="text-xs font-medium uppercase tracking-wider text-gray-500">Sent</dt>
