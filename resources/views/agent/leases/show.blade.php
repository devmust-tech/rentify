        ...
        <div class="px-6 py-6">
            <dl class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm font-semibold text-gray-900">{{ $lease->end_date->format('d/m/Y') }}</dd>
                </div>
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if($lease->signature_url)
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-3">
                                <img src="{{ Storage::url($lease->signature_url) }}" alt="Tenant signature" class="h-16">
                            </div>
                        @endif
                    </div>
                </div>
