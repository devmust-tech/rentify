<x-guest-layout>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Set up your account</h1>
        <p class="mt-2 text-sm text-gray-500">Welcome, {{ $landlord->user->name }}. Choose a password to activate your landlord portal.</p>
    </div>

    <form method="POST" action="{{ request()->fullUrl() }}" x-data="{ showPassword: false, showConfirm: false }">
        @csrf
