<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('landlord.leases.index') }}" class="rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-colors">
                Back to Leases
            </a>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl" x-data="leaseForm()">
        <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5">
            ...
            <form action="{{ route('landlord.leases.store') }}" method="POST" class="px-6 py-6">
                @csrf
