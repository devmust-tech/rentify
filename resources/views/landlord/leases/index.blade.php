                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right text-sm">
                            <div class="inline-flex items-center gap-x-3">
                                ...
                                <a href="{{ route('landlord.leases.edit', $lease) }}" class="font-medium text-emerald-600 hover:text-emerald-500 transition-colors">Edit</a>
                            </div>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="mt-4 text-sm font-medium text-gray-900">No leases yet</p>
                                <p class="mt-1 text-sm text-gray-500">Get started by creating a new lease.</p>
                                <a href="{{ route('landlord.leases.create') }}" class="mt-4 inline-flex items-center gap-x-2 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 transition-colors">Create Lease</a>
                            </div>
                        </td>
                    </tr>
                @endforelse
