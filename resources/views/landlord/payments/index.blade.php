    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">View and record rent payments</p>
            </div>
            <a href="{{ route('landlord.payments.create') }}" class="inline-flex items-center gap-x-2 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 transition-colors">
                ...
                @forelse($payments as $payment)
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right text-sm">
                            <a href="{{ route('landlord.invoices.show', $payment->invoice) }}" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">View Invoice</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <a href="{{ route('landlord.payments.create') }}" class="mt-4 inline-flex items-center gap-x-2 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 transition-colors">Record Payment</a>
                            </div>
                        </td>
                    </tr>
                @endforelse
