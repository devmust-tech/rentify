                                        ...
                                        <div x-show="checked" x-collapse class="border-t border-gray-200 px-4 py-4 space-y-4 bg-white/50">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="amenity_data[{{ $amenity->id }}][provider]" value="{{ old("amenity_data.{$amenity->id}.provider") }}"
                                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition" placeholder="e.g. Safaricom, Kenya Power">
                                            </div>
                                            <div x-show="!includedInRent">
                                                ...
                                                <input type="number" name="amenity_data[{{ $amenity->id }}][monthly_cost]" value="{{ old("amenity_data.{$amenity->id}.monthly_cost") }}"
                                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition" placeholder="0.00" step="0.01" min="0">
                                            </div>
                                            <div>
                                                ...
                                                <input type="text" name="amenity_data[{{ $amenity->id }}][notes]" value="{{ old("amenity_data.{$amenity->id}.notes") }}"
                                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm transition" placeholder="Any additional details...">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
